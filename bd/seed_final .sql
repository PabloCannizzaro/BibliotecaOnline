...
-- Este seed reinicia solamente los datos. Ejecutarlo despues de schema_final.sql.
-- Los usuarios administradores se asignan por nombre de rol, no por un ID supuesto.
...
(31, 'CP-0031-01', 'available', 'good', NOW()),
(31, 'CP-0031-02', 'available', 'good', NOW());

-- Usuarios normales y administradores
SET @admin_role_id = (SELECT role_id FROM roles WHERE role_name = 'admin' LIMIT 1);
SET @user_role_id = (SELECT role_id FROM roles WHERE role_name = 'user' LIMIT 1);

INSERT INTO users (first_name, last_name, email, password_hash, role_id, status) VALUES
('Valeria', 'González', 'valeria@example.com', '$2a$10$Dci1HmSoluBOiOy03C8.3ecQ60K2jhcp/gpQl6e2NibX.4Jr6FC6C', @admin_role_id, 'active'),
('Admin', 'Central', 'admin@example.com', '$2a$10$J6gvNJupIwWAKveF7R0XVuIjcgASIxCwkZx.OxJeH5rsJlSC0o74O', @admin_role_id, 'active'),
('Santiago', 'Pérez', 'santiago@example.com', '$2a$10$uzv0Zi/TGS4usgHCZKgET.VarJtVHyrfr16.wn3VAKu9kzCdfhG/G', @user_role_id, 'active'),
('María', 'Rodríguez', 'maria@example.com', '$2a$10$uzv0Zi/TGS4usgHCZKgET.VarJtVHyrfr16.wn3VAKu9kzCdfhG/G', @user_role_id, 'active'),
('Lucas', 'Fernández', 'lucas@example.com', '$2a$10$uzv0Zi/TGS4usgHCZKgET.VarJtVHyrfr16.wn3VAKu9kzCdfhG/G', @user_role_id, 'active'),
('Camila', 'García', 'camila@example.com', '$2a$10$uzv0Zi/TGS4usgHCZKgET.VarJtVHyrfr16.wn3VAKu9kzCdfhG/G', @user_role_id, 'active'),
('Martín', 'Díaz', 'martin@example.com', '$2a$10$uzv0Zi/TGS4usgHCZKgET.VarJtVHyrfr16.wn3VAKu9kzCdfhG/G', @user_role_id, 'active'),
('Lucía', 'Herrera', 'lucia@example.com', '$2a$10$uzv0Zi/TGS4usgHCZKgET.VarJtVHyrfr16.wn3VAKu9kzCdfhG/G', @user_role_id, 'active'),
('Nicolás', 'Sosa', 'nicolas@example.com', '$2a$10$uzv0Zi/TGS4usgHCZKgET.VarJtVHyrfr16.wn3VAKu9kzCdfhG/G', @user_role_id, 'active'),
('Florencia', 'Núñez', 'florencia@example.com', '$2a$10$uzv0Zi/TGS4usgHCZKgET.VarJtVHyrfr16.wn3VAKu9kzCdfhG/G', @user_role_id, 'active'),
('Diego', 'Ramos', 'diego@example.com', '$2a$10$uzv0Zi/TGS4usgHCZKgET.VarJtVHyrfr16.wn3VAKu9kzCdfhG/G', @user_role_id, 'active'),
('Sofía', 'Mendoza', 'sofia@example.com', '$2a$10$uzv0Zi/TGS4usgHCZKgET.VarJtVHyrfr16.wn3VAKu9kzCdfhG/G', @user_role_id, 'active'),
('Andrés', 'López', 'andres@example.com', '$2a$10$uzv0Zi/TGS4usgHCZKgET.VarJtVHyrfr16.wn3VAKu9kzCdfhG/G', @user_role_id, 'active'),
('Mónica', 'Blanco', 'monica@example.com', '$2a$10$uzv0Zi/TGS4usgHCZKgET.VarJtVHyrfr16.wn3VAKu9kzCdfhG/G', @user_role_id, 'active'),
('Clara', 'Paz', 'clara@example.com', '$2a$10$uzv0Zi/TGS4usgHCZKgET.VarJtVHyrfr16.wn3VAKu9kzCdfhG/G', @user_role_id, 'active'),
('Tomás', 'Bravo', 'tomas@example.com', '$2a$10$uzv0Zi/TGS4usgHCZKgET.VarJtVHyrfr16.wn3VAKu9kzCdfhG/G', @user_role_id, 'active'),
('Paula', 'Campos', 'paula@example.com', '$2a$10$uzv0Zi/TGS4usgHCZKgET.VarJtVHyrfr16.wn3VAKu9kzCdfhG/G', @user_role_id, 'active');
...
(1, (SELECT copy_id FROM copies WHERE barcode = 'CP-0001-02'), 1, 1),
(2, (SELECT copy_id FROM copies WHERE barcode = 'CP-0014-01'), 14, 1),
(3, (SELECT copy_id FROM copies WHERE barcode = 'CP-0008-03'), 8, 1);

UPDATE copies SET status = 'loaned' WHERE barcode IN ('CP-0001-02', 'CP-0014-01');
UPDATE copies SET status = 'available' WHERE barcode = 'CP-0008-03';
...
(1, (SELECT copy_id FROM copies WHERE barcode = 'CP-0001-02'), 1, 'loan', NOW() - INTERVAL 8 DAY, 'Préstamo activo de ejemplo'),
(14, (SELECT copy_id FROM copies WHERE barcode = 'CP-0014-01'), 1, 'loan', NOW() - INTERVAL 18 DAY, 'Préstamo vencido de ejemplo'),
